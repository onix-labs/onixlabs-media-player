...
| **Onix** | Waves | Pulsating gradient circle with ONIXLabs brand colors via conic gradient stroke, rotating trail effect with zoom, inner white circle pulsates to bass/kick drums with black stroked edge, proper waveform smoothing support | Pre-computed trig lookup tables, conic gradient for single-pass colored stroke, reuses trail/temp canvases |
