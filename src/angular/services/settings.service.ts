...
export const VISUALIZATION_METADATA: readonly VisualizationMetadata[] = [
  ...
  {id: 'ambience-water', name: 'Water', category: 'Ambience', applicableSettings: []},
  ...
  {id: 'ambience-rush', name: 'Rush', category: 'Ambience', applicableSettings: []},
  {id: 'ambience-petals', name: 'Petals', category: 'Ambience', applicableSettings: []},
  {id: 'ambience-weave', name: 'Weave', category: 'Ambience', applicableSettings: []},
  {id: 'ambience-bloom', name: 'Bloom', category: 'Ambience', applicableSettings: []},
  {id: 'ambience-whirl', name: 'Whirl', category: 'Ambience', applicableSettings: []},
  // Battery category
  {id: 'battery-cominatya', name: 'Cominatya', category: 'Battery', applicableSettings: []},
  {id: 'battery-dandelion-aid', name: 'Dandelion Aid', category: 'Battery', applicableSettings: []},
  {id: 'battery-drowning-flower', name: 'Drowning Flower', category: 'Battery', applicableSettings: []},
  {id: 'battery-eletri-arnation', name: 'Eletri Arnation', category: 'Battery', applicableSettings: []},
  {id: 'battery-groove-swirl', name: 'Groove Swirl', category: 'Battery', applicableSettings: []},
  {id: 'battery-i-see-the-truth', name: 'I See The Truth', category: 'Battery', applicableSettings: []},
  {id: 'battery-geeks-kick-ascii', name: 'Geeks Kick ASCII', category: 'Battery', applicableSettings: []},
  {id: 'battery-nerds-are-cool', name: 'Nerds Are Cool', category: 'Battery', applicableSettings: []},
  {id: 'battery-spider-s-last-moment', name: "Spider's Last Moment", category: 'Battery', applicableSettings: []},
  {id: 'battery-illuminator', name: 'Illuminator', category: 'Battery', applicableSettings: []},
  {id: 'battery-kaleidoscope', name: 'Kaleidoscope', category: 'Battery', applicableSettings: []},
  {id: 'battery-what-is-an-egab', name: 'What Is An Egab', category: 'Battery', applicableSettings: []},
  {id: 'battery-tornado', name: 'Tornado', category: 'Battery', applicableSettings: []},
  {id: 'battery-gemstone-matrix', name: 'Gemstone Matrix', category: 'Battery', applicableSettings: []},
  {id: 'battery-lotus', name: 'Lotus', category: 'Battery', applicableSettings: []},
  {id: 'battery-khemical-nova', name: 'Khemical Nova', category: 'Battery', applicableSettings: []},
  {id: 'battery-smoke-or-water', name: 'Smoke Or Water', category: 'Battery', applicableSettings: []},
  {id: 'battery-bright-sphere', name: 'Bright Sphere', category: 'Battery', applicableSettings: []},
  {id: 'battery-cotton-star', name: 'Cotton Star', category: 'Battery', applicableSettings: []},
  {id: 'battery-sleepy-spray', name: 'Sleepy Spray', category: 'Battery', applicableSettings: []},
  {id: 'battery-circle-dance', name: 'Circle Dance', category: 'Battery', applicableSettings: []},
  {id: 'battery-event-horizon', name: 'Event Horizon', category: 'Battery', applicableSettings: []},
  {id: 'battery-relatively-calm', name: 'Relatively Calm', category: 'Battery', applicableSettings: []},
  {id: 'battery-strawberry-aid', name: 'Strawberry Aid', category: 'Battery', applicableSettings: []},
  {id: 'battery-the-world', name: 'The World', category: 'Battery', applicableSettings: []},
  // Simple category
...
export const VISUALIZATION_OPTIONS: readonly VisualizationOption[] = [
  ...
  {value: 'ambience-water', label: 'Ambience : Water', description: 'Concentric rings dispersing a waveform outward, under horizontal smoke'},
  ...
  {value: 'ambience-rush', label: 'Ambience : Rush', description: 'Cubic zoom driven hard, with the spectrum along the edge'},
  {value: 'ambience-petals', label: 'Ambience : Petals', description: 'Inflow with the angle stepped into sectors'},
  {value: 'ambience-weave', label: 'Ambience : Weave', description: 'The gentlest of the rotating inflows'},
  {value: 'ambience-bloom', label: 'Ambience : Bloom', description: 'Rotating outflow, opening from the centre'},
  {value: 'ambience-whirl', label: 'Ambience : Whirl', description: 'Quarter-width falloff twisting radius and angle together'},
  // Battery category
  {value: 'battery-cominatya', label: 'Battery : Cominatya', description: 'Stretch warp fed by JiggyScribble'},
  {value: 'battery-dandelion-aid', label: 'Battery : Dandelion Aid', description: 'Starburst warp fed by JiggyScribble and JDar'},
  {value: 'battery-drowning-flower', label: 'Battery : Drowning Flower', description: 'Shiitake warp fed by SpectrumEdge and JiggyScribble'},
  {value: 'battery-eletri-arnation', label: 'Battery : Eletri Arnation', description: 'Starburst warp fed by JiggyScribble and JDar'},
  {value: 'battery-groove-swirl', label: 'Battery : Groove Swirl', description: 'Shiitake warp fed by EdgeGradiant and CircleWaveform'},
  ...
  {value: 'battery-tornado', label: 'Battery : Tornado', description: 'Swirl warp fed by CircleWaveform'},
  {value: 'battery-gemstone-matrix', label: 'Battery : Gemstone Matrix', description: 'Tile warp fed by JDar'},
  {value: 'battery-lotus', label: 'Battery : Lotus', description: 'Starburst warp fed by EdgeTrace and DotPlane'},
  {value: 'battery-khemical-nova', label: 'Battery : Khemical Nova', description: 'Starburst warp fed by EdgeGradiant and CircleWaveform and JDar'},
  {value: 'battery-smoke-or-water', label: 'Battery : Smoke Or Water', description: 'Swirl warp fed by JDar'},
  {value: 'battery-bright-sphere', label: 'Battery : Bright Sphere', description: 'RingSpin warp fed by DotPlane'},
  {value: 'battery-cotton-star', label: 'Battery : Cotton Star', description: 'Starburst warp fed by EdgeGradiant and DotPlane'},
  {value: 'battery-sleepy-spray', label: 'Battery : Sleepy Spray', description: 'Linear warp fed by DotPlane'},
  {value: 'battery-circle-dance', label: 'Battery : Circle Dance', description: 'Tile warp fed by EdgeTrace and CircleWaveform'},
  {value: 'battery-event-horizon', label: 'Battery : Event Horizon', description: 'Shiitake warp fed by SpectrumEdge and DotPlane'},
  {value: 'battery-relatively-calm', label: 'Battery : Relatively Calm', description: 'Twirlocity warp fed by SpectrumEdge and JDar and DotPlane'},
  {value: 'battery-strawberry-aid', label: 'Battery : Strawberry Aid', description: 'Stretch warp fed by CosEdgeGradiant and CircleWaveform and JDar'},
  {value: 'battery-the-world', label: 'Battery : The World', description: 'Shiitake warp fed by SpectrumEdge and CircleWaveform and DotPlane'},
  // Simple category
