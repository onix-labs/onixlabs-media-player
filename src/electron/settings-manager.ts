...
const VALID_VISUALIZATION_TYPES: readonly string[] = [
  ...
  'ambience-whirl',
  'battery-cominatya',
  'battery-dandelion-aid',
  'battery-drowning-flower',
  'battery-eletri-arnation',
  'battery-groove-swirl',
  'battery-i-see-the-truth',
  'battery-geeks-kick-ascii',
  'battery-nerds-are-cool',
  'battery-spider-s-last-moment',
  'battery-illuminator',
  'battery-kaleidoscope',
  'battery-what-is-an-egab',
  'battery-tornado',
  'battery-gemstone-matrix',
  'battery-lotus',
  'battery-khemical-nova',
  'battery-smoke-or-water',
  'battery-bright-sphere',
  'battery-cotton-star',
  'battery-sleepy-spray',
  'battery-circle-dance',
  'battery-event-horizon',
  'battery-relatively-calm',
  'battery-strawberry-aid',
  'battery-the-world',
  'blank',
  'logo',
];
