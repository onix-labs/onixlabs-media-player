...
const VISUALIZATION_CATEGORIES: ReadonlyArray<{
  ...
  },
  {
    ...
    items: [
      ...
      {id: 'battery-spectrumedge', name: 'Spectrum Edge'},
      {id: 'battery-circlewaveform', name: 'Circle Waveform'},
      {id: 'battery-edgegradiant', name: 'Edge Gradiant'},
      {id: 'battery-cosedgegradiant', name: 'Cos Edge Gradiant'},
      {id: 'battery-edgetrace', name: 'Edge Trace'},
      {id: 'battery-dotplane', name: 'Dot Plane'},
      {id: 'battery-jdar', name: 'JDar'},
      {id: 'battery-galaxy', name: 'Galaxy'},
